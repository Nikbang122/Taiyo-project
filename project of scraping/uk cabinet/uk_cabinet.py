...
driver = webdriver.Chrome(executable_path="/home/nikhil/Downloads/chromedriver",options=chrome_options) #La unching Chrome Driver
...
final_data.to_csv('uk_cabinet.csv')
